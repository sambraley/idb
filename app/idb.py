...
member_info = [
    {'name': 'Nick Kantor',    'image': 'nick_kantor.png',   'commits': 5, 'issues': 1, 'tests': 1, 'responsibilities': "Front-End Developer", 'bio': "I'm a Senior Computer Science student and tend to spend my free time playing my trumpet for the longhorn band. After I graduate I plan on pursuing a Master's degree in Computer Science."},
    {'name': 'Samuel Braley',  'image': 'samuel_braley.jpg', 'commits': 5, 'issues': 1, 'tests': 1, 'responsibilities': "Documentation and Apiary", 'bio': "I am a Computer Science senior with certificates in Business Foundations and Game Design. I enjoy being one of the many Sams in the world and plan on being a programmer manager after I graduate."},
    {'name': 'Taben Malik',    'image': 'taben.jpg', 		    'commits': 5, 'issues': 1, 'tests': 1, 'responsibilities': "Data Collection and Modeling", 'bio': "A double major in Computer Science and Aerospace Engineering. I am a strong advocate of a Mars mission and hope to be a part of one someday."},
    {'name': 'Gustavo Osorio', 'image': 'gustavo.jpg',       'commits': 5, 'issues': 1, 'tests': 1, 'responsibilities': "UML Design and Modeling", 'bio': "I'm a senior Computer Science student. I enjoy dancing and coding, but I'm not skilled enough to do both simultaneously."},
    {'name': 'Scott Farrior',  'image': 'sfarrior.jpg',      'commits': 5, 'issues': 1, 'tests': 1, 'responsibilities': "Server setup/administration and SQLAlchemy backend", 'bio': "I'm a Computer Science major. I work as a TA/Grader as well as Computer Lab technician for the community college, and would like to be an instructor one day."},
    {'name': 'David Ares',     'image': 'david.jpg',         'commits': 5, 'issues': 1, 'tests': 1, 'responsibilities': "Front-End Developer", 'bio': "I am a non-traditional student with one year of Full-stack web development. Before returning to school, I gained seven years of experience in sales, marketing, and management."}]

about_info = {'commits': 70, 'issues': 20, 'tests': 2}

planetoids = [
    {"link": "planetoids/1", "name": "HAT-P-33 b", "right_ascension": "113.184212", "declination": "33.835052", "diameter": "235739.892", "mass": "1.446276e+27", "surface_temperature":"1782", "gravity": "0.006947625786270114", "orbital_period": "3.474474", "orbiting_bodies": "NULL", "satellites": "Satellites", "images": "HAT-P-33 b.png", "host": "HAT-P-33"},
    {"link": "planetoids/2", "name": "HAT-P-34 b", "right_ascension": "303.195342", "declination": "18.104868", "diameter": "167366.934", "mass": "6.316544e+27", "surface_temperature":"1520", "gravity": "0.06019932261381838", "orbital_period": "5.452654", "orbiting_bodies": "NULL", "satellites": "Satellites", "images": "HAT-P-34 b.png", "host": "HAT-P-34"},
...
satellites = [
    ...
    {"link": "satellites/2", "name": "Nuclear Spectroscopic Telescope Array (NuSTAR)", "agency": "National Aeronautics and Space Administration", "type_of_mission": "astrophysics", "year_launched": "2012", "oribital_period": "NULL", "images": "628206main_pia15265-fullnew.jpg", "stars": "/stars", "planetoid_bodies": "/planetoids", "galaxies": "/galaxies"},
...
galaxies = [
    {"link": "galaxies/1", "name": "UGC 11693", "images": "UGC 11693.png", "right_ascension": "317.819183", "declination": "37.884811", "galaxy_type":"spiral", "redshift": "0.093554", "angular_size": "1.227", "stars": "/stars", "planetoid_bodies": "/planetoids", "satellites": "/satellites"},
