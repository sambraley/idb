...
def load_db():
    ...
    planets_json = json.loads(open('planets.json').read())
    galaxies_json = json.loads(open('galaxies.json').read())
    satellites_json = json.loads(open('satellites.json').read())
    stars_json = json.loads(open('stars.json').read())
