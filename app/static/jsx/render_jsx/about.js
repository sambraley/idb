...
var member_info = [
    ...
    {'name': 'Taben Malik',    'github_id': 'tabenmalik',   'image': 'taben.jpg', 		    'p1_lead': false, 'p2_lead': false,  'tests': 0,   'responsibilities': "Data Collection and Modeling", 'bio': "A double major in Computer Science and Aerospace Engineering. I am a strong advocate of a Mars mission and hope to be a part of one someday."},
    {'name': 'Gustavo Osorio', 'github_id': 'lpztavo',      'image': 'gustavo.jpg',       'p1_lead': false, 'p2_lead': false,  'tests': 12,  'responsibilities': "UML Design and Modeling", 'bio': "I'm a senior Computer Science student. I enjoy dancing and coding, but I'm not skilled enough to do both simultaneously."},
    {'name': 'Scott Farrior',  'github_id': 'sfarrior',     'image': 'sfarrior.jpg',      'p1_lead': false, 'p2_lead': true,   'tests': 0,   'responsibilities': "Server setup/administration and SQLAlchemy backend", 'bio': "I'm a Computer Science major. I work as a TA/Grader as well as Computer Lab technician for the community college, and would like to be an instructor one day."},
    {'name': 'David Ares',     'github_id': 'dares23',      'image': 'david.jpg',         'p1_lead': false, 'p2_lead': false,  'tests': 0,   'responsibilities': "Front-End Developer", 'bio': "I am a non-traditional student with one year of Full-stack web development. Before returning to school, I gained seven years of experience in sales, marketing, and management."}]
