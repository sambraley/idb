...
var Carousel = function (_React$Component) {
	...
	function Carousel(props) {
		...
		_this.urls = [];
		_this.urls.push(_this.parseJSON("testing"));
		return _this;
	}
	...
	_createClass(Carousel, [{
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(_carouselItem2.default, { url: this.urls[0], message: "Welcome to the final frontier!!!", "class": "active" }),
				React.createElement(_carouselItem2.default, { url: this.urls[0], message: "2", "class": "" }),
				React.createElement(_carouselItem2.default, { url: this.urls[0], message: "3", "class": "" })
			);
		}
	}]);
...
},{"./carouselItem.jsx":2,"isomorphic-fetch":4}],2:[function(require,module,exports){
"use strict";
...
},{"./carousel.jsx":1}],4:[function(require,module,exports){
